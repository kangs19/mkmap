...
from mkmap_meta.connectors.events import TyphoonConnector
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test live KMA typhoon information calls.")
...
def main() -> int:
    ...
    return run_live_event_test(
        connector_factory=TyphoonConnector,
        service_name="kma_typhoon",
