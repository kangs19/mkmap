...
def _explain_prediction(
    *,
    ...
    return {
        ...
        "held_out": prediction.get("held_out", False),
        "available": prediction.get("available", True),
        "readiness_status": prediction.get("readiness_status"),
        "readiness_reasons": prediction.get("readiness_reasons", []),
        "readiness_gate": prediction.get("readiness_gate", {}),
