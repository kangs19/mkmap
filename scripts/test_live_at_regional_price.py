...
from mkmap_meta.connectors.price import AtRegionalPriceConnector
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Smoke test aT regional retail/wholesale price integration.")
...
def main() -> int:
    ...
    connector = AtRegionalPriceConnector(registry=default_registry())
