...
from mkmap_meta.connectors.events import ImpactForecastConnector
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test live KMA impact forecast calls.")
...
def main() -> int:
    ...
    return run_live_event_test(
        connector_factory=ImpactForecastConnector,
        service_name="kma_impact_forecast",
