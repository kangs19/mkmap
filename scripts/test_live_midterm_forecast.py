...
from mkmap_meta.connectors.events import MidtermForecastConnector
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test live KMA midterm forecast calls.")
...
def main() -> int:
    ...
    return run_live_event_test(
        connector_factory=MidtermForecastConnector,
        service_name="kma_midterm_forecast",
